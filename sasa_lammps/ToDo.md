...
- Generalu´ize the postprocessing: More adaptable graphs, less hardcoded  labels etc...
...
- Move the lmp-input files into a `resources` directory and use `importlib.resources`
